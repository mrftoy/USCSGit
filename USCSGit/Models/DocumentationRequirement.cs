namespace USCS.Models
{
    ...
    [Table("DocumentationRequirement")]
    public partial class DocumentationRequirement
    {
        ...
        public int DocumentationRequirementID { get; set; }

        [Column("DocumentationRequirement")]
        [Required]
        [StringLength(2000)]
